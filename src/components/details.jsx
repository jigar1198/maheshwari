...
class Details extends Component {
  ...
  render() {
    ...
    return (
      <div>
       <Grid container>
        <Typography variant="h5" className={classes.header} align="center">Personal Details:</Typography>
       ...
       <Grid container>
        <Typography variant="h5" className={classes.header} align="center">Company Details:</Typography>
        <Paper className={classes.root}>
          <Table className={classes.table}>
            <TableBody>
              {rows2.map(row => (  
